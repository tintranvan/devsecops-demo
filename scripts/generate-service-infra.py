...
module "ecs_service" {{
  ...
  # Basic Configuration
  name_prefix    = "devsecops-{environment}"
  service_name   = "{name}"
...
variable "image_uri" {{
  ...
  type        = string
  default     = "647272350116.dkr.ecr.us-east-1.amazonaws.com/devsecops-{environment}-java-app:{version or 'latest'}"
}}
