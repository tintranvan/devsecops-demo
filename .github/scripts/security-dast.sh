    ...
    for site in zap_data.get('site', []):
        for alert in site.get('alerts', []):
            ...
            finding = {
                ...
                "ProductArn": "arn:aws:securityhub:{os.getenv('AWS_REGION', 'us-east-1')}:{os.getenv('AWS_ACCOUNT_ID')}:product/{os.getenv('AWS_ACCOUNT_ID')}/default",
...
SQS_QUEUE_URL="https://sqs.${AWS_REGION}.amazonaws.com/${AWS_ACCOUNT_ID}/${SECURITY_FINDINGS_QUEUE}"
